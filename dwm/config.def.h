...
static const char col_cyan[]        = "#005577"; // fedora blue color #072c61, original #005577
static const unsigned int baralpha = 0xff; // originally set to '0xd0'
static const unsigned int borderalpha = OPAQUE;
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_white, col_darkergray, col_darkergray },
	[SchemeSel]  = { col_white, col_dark, col_darkgray },
};
